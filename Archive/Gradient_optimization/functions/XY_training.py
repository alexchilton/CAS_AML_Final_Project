    ...
    def train(self, train_loader, test_loader, epochs=50, prints=10,
        ...
        for epoch in range(epochs):
            ...
            for data_x, data_y in train_loader:
                ...
                # These tensors are used for computation and should all be on the same device
                train_recon_loss += loss_fn(out['reconstructed'], d['y'])
            ...
            for data_x, data_y in test_loader:
                ...
                test_recon_loss += loss_fn(out['reconstructed'], d['y'])
