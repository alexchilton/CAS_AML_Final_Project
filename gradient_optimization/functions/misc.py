...
def compare_images(cmaps: list, titles: list, masking=False, mask=None):
    ...
    if masking:
        for contact_map in cmaps:
            contact_map[~mask] = 0.5
...
def reconstruct_coords_local_plural_maps(contact_maps: list, configs: list, sharpness=10., window=25, dim=3, lr=1e-3, max_iter=1000, prints=10):
    """
